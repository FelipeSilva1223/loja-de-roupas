...
if (sessionStorage.getItem("usuariologado") === "true" || localStorage.getItem("usuariologado") === "true"){
    ...
    if(sessionStorage.getItem("hierarquia") === "admin"){
        opcoes = `
        <li><a href="loja-de-roupas/paginas/admin/adicionar.html" class="dropdown-item">Painel de controle</a></li>
        <li><a href="loja-de-roupas/paginas/login.html" class="dropdown-item">Log out</a></li>`
    } else {
        opcoes = `
    ...
    opcoes = `
    <li><a href="loja-de-roupas/paginas/login.html" class="dropdown-item">Log in/Sign in</a></li>`
}
...
headerTag.insertAdjacentHTML('afterbegin', `
        <nav class="navbar justify-content-between align-items-center px-3 py-2" style="background-color: #0E2340;">
            <div name="logo">
                <a href="loja-de-roupas/index.html" class="logo-marca mb-0" style="text-decoration: none;">Logotipo</a>
            </div>
            <div class="dropdown">
                ...
                <a href="loja-de-roupas/paginas/publico/carrinho.html" class="bi bi-cart4 me-3 icone-header position-relative">
